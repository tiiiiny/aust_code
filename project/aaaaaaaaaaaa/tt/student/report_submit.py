...
class report_submit_System:
    def __init__(self):
        ...
        # self.book_button = tk.Button(self.root, text="提交报告", command=self.book_experiment)
    ...
    def submit_report(self):
        ...
        dbsql.submin(student_id,experiment_id)
        self.update_ui()
        # print(f"提交实验报告 {experiment_id}")
