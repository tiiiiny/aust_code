...
distances = [2.86, 1.65, 1.65]  # 点A与B之间的距离，B与C之间的距离，C与D之间的距离
...
# 初始化绘图对象
lines = [ax.plot([], [], label=f"Point {chr(ord('A') + i)}")[0] for i in range(4)]
points = [ax.plot([], [], 'o', markersize=8)[0] for _ in range(4)]
